...
let DashboardService = DashboardService_1 = class DashboardService {
    ...
    async getStatsWithComparison(period, date) {
        try {
            ...
            this.logger.error(`Error getting stats with comparison for ${period}:`, error);
            throw error;
        }
    }
    ...
    async aggregateDataFromRange(start, end, period) {
        try {
            ...
            const allVariantIds = orders.flatMap((order) => (order.items || [])
    ...
    async aggregateMonthlyData() {
        ...
        return await this.aggregateDataFromRange(startOfMonth, endOfMonth, 'monthly');
    }
